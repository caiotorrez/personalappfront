...
public class TreinoCreateBean implements Serializable {
	...
	private String nome;
	private int indexRederizacaoTreinos = 0;
	private String renderTreino = "grupoB";
	private String derender = "grupoB";
	...
	public int getIndexTreino() {
		return this.indexRederizacaoTreinos;
	}
	
	public void incremetaTreino() {
		this.indexRederizacaoTreinos++;
		if (this.indexRederizacaoTreinos == 1) {
			this.renderTreino = "grupoC";
			this.derender = "grupoB";
		} else if (this.indexRederizacaoTreinos == 2) {
			this.renderTreino = "grupoD";
			this.derender = "grupoC";
		} else if (this.indexRederizacaoTreinos == 3) {
			this.renderTreino = "grupoE";
			this.derender = "grupoD";
		}else {
			this.derender = "grupoE";
		}
	}
	...
	public void decrementaTreino() {
		this.indexRederizacaoTreinos--;
		if (this.indexRederizacaoTreinos == 0) {
			this.renderTreino = "grupoB";
			this.derender = "grupoB";
		} else if (this.indexRederizacaoTreinos == 1) {
			this.renderTreino = "grupoC";
			this.derender = "grupoB";
		} else if (this.indexRederizacaoTreinos == 2) {
			this.renderTreino = "grupoD";
