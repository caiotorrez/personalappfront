...
@Named
@SessionScoped
public class TreinoAlunoViewBean implements Serializable {
	...
	@Inject
	public TreinoAlunoViewBean(AlunoDao alunoDao) {
		this.alunoDao = alunoDao;
	}

	public void searchTreino(String username) {
		this.aluno = this.alunoDao.findOne(username);
	}
